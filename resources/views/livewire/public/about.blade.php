...
<div class="bg-bg-light">
    ...
    <section class="relative h-[50vh] min-h-[350px] overflow-hidden flex items-center justify-center">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl">
            <div class="flex items-center justify-center gap-4 mb-6">
                ...
                <span class="text-primary font-bold uppercase tracking-[0.3em] text-xs">Our Story</span>
                <div class="w-8 sm:w-12 h-[2px] bg-primary"></div>
            </div>
            ...
            <p class="text-white/70 text-base sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
                The journey behind our legacy and the passion that drives us.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-5 gap-12 lg:gap-20">
                ...
                <div class="lg:col-span-3">
                    <div class="space-y-4 mb-10">
                        <div class="flex items-center gap-4">
                            <div class="w-8 sm:w-12 h-[2px] bg-primary"></div>
                            <span class="text-primary font-bold uppercase tracking-[0.3em] text-xs">Who We Are</span>
                        </div>
                        <h2 class="text-3xl sm:text-4xl font-extrabold text-secondary leading-tight">
                            The Journey Behind<br>Our Legacy.
                        </h2>
                    </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-secondary p-8 sm:p-10 rounded-xl text-white">
                        <span class="text-4xl sm:text-5xl font-extrabold text-primary block mb-2">{{ $settings['about_stat_number'] ?? '15+' }}</span>
                        <p class="text-sm font-medium text-white/70 uppercase tracking-widest leading-relaxed">{{ $settings['about_stat_text'] ?? 'Years of Crafting Bespoke Experiences' }}</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="p-6 sm:p-8 bg-white border border-secondary/5 rounded-xl hover:shadow-2xl transition-all group">
                            ...
                            <h3 class="text-lg font-extrabold text-secondary mb-2">Exceptional Quality</h3>
                            <p class="text-secondary/60 leading-relaxed font-light text-sm">Every detail curated to perfection for an unforgettable experience.</p>
                        </div>
                        <div class="p-6 sm:p-8 bg-white border border-secondary/5 rounded-xl hover:shadow-2xl transition-all group">
                            <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
                                <i class="material-icons text-2xl">verified_user</i>
                            </div>
                            <h3 class="text-lg font-extrabold text-secondary mb-2">Trusted Expertise</h3>
                            <p class="text-secondary/60 leading-relaxed font-light text-sm">Deep local knowledge and years of experience crafting bespoke journeys.</p>
                        </div>
                        <div class="p-6 sm:p-8 bg-white border border-secondary/5 rounded-xl hover:shadow-2xl transition-all group">
                            <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
                                <i class="material-icons text-2xl">favorite</i>
                            </div>
                            <h3 class="text-lg font-extrabold text-secondary mb-2">Personal Touch</h3>
                            <p class="text-secondary/60 leading-relaxed font-light text-sm">Custom-built itineraries tailored to your unique desires and preferences.</p>
                        </div>
                    </div>
                </div>
            </div>
        @else
            <div class="text-center py-20">
                ...
                <h2 class="text-2xl font-extrabold text-secondary mb-2">Content Coming Soon</h2>
                <p class="text-secondary/50 font-light">The About page content has not been set yet.</p>
            </div>
        @endif
    </section>
    ...
    <section class="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-secondary">
        ...
        <div class="relative z-10 px-4 sm:px-6 md:px-8 max-w-4xl mx-auto text-center">
            <h2 class="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white mb-6 sm:mb-8 tracking-tight">Ready to Explore?</h2>
            <p class="text-white/60 text-base sm:text-lg mb-8 sm:mb-12 font-light">Browse our curated destinations and start planning your next extraordinary journey.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                @if($settings['whatsapp_number'] ?? false)
                    <a href="https://wa.me/{{ $settings['whatsapp_number'] }}" target="_blank" class="border border-white/20 text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl font-bold uppercase tracking-widest text-xs sm:text-sm hover:bg-white/10 transition-colors">
                        Contact Us
                    </a>
                @endif
            </div>
